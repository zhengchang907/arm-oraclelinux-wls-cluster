...
#    * Azure WebLogic application has deployed, WebLogic Cluster has an Admin Server.
#    * The WebLogic Cluster has as least one managed nodes
...
function removeManagedNodes {
    ...
    # delete nodes from weblogic cluster
